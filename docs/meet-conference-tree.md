...
- Avg **2.4** imports/file
  ...
  component: 58 · hook: 32 · page: 23 · util: 8 · service: 5 · type: 4 · store: 3 · entry: 1 · router: 1 · context: 1 · config: 1
...
├── 🔌 services/database.ts (service) ← 24 importers
├── 🛡️ middleware/authenticate.ts (middleware) ← 22 importers
├── 🛡️ middleware/requireRole.ts (middleware) ← 12 importers
├── 🔌 services/cache.ts (service) ← 10 importers
├── 🔌 services/redis.ts (service) ← 10 importers
├── ⚙️ config.ts (config) ← 9 importers
├── 🔌 services/livekit.ts (service) ← 6 importers
