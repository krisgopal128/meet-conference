            ...
            <div className="p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {/* Title */}
                  <h4 className={`mt-1 font-medium ${isRead ? 'text-gray-600' : 'text-gray-900'}`}>
                    {alert.title}
                  </h4>

                  {/* Message */}
                  {alert.message && (
                    <p className={`mt-1 text-sm ${isRead ? 'text-gray-500' : 'text-gray-600'}`}>
                      {alert.message}
                    </p>
                  )}

                  {/* Timestamp */}
                  <p className="mt-2 text-xs text-gray-400" title={formatFullDate(alert.createdAt)}>
